...
const ProfileView: React.FC<ProfileViewProps> = ({ themeColor, onThemeChange }) => {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8 pb-12">
      ...
      >
        <img 
          src={user.photoURL || 'https://ui-avatars.com/api/?name=User&background=0284c7&color=fff'} 
        ...
        <div className="text-center md:text-left flex-1">
          ...
          <div className="mt-4 flex flex-wrap justify-center md:justify-start gap-3">
            <span className="px-3 py-1 bg-brand/5 text-brand rounded-lg text-[10px] font-bold uppercase tracking-wider flex items-center gap-1.5 border border-brand/10">
              <ShieldCheck className="w-3 h-3" /> Modo Acesso Livre
            </span>
          </div>
        </div>
      </motion.div>
